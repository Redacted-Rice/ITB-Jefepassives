...
modApi:appendAsset("img/weapons/passives/passive_taunt_field.png",          resourcePath.."img/weapons/passives/passive_taunt_field.png")
modApi:appendAsset("img/weapons/passives/passive_waterfall.png",            resourcePath.."img/weapons/passives/passive_waterfall.png")
